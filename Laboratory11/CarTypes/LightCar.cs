namespace Car
{
    public class LightCar : Car
    {
        ...
        public Car GetBase
        {
            get => new Car(Brand, Year, Color, Price, Clearance); // Создаем новый объект базового класса
        }
        ...
        public override object Clone()
        {
            ...
            // Глубокое копирование полей класса LightCar
        ...
        {
            return HashCode.Combine(base.GetHashCode(), SeatCount, MaxSpeed);
        }
    }
}