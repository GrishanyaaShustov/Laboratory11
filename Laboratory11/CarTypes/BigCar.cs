namespace Car
{
    public class BigCar : Car
    {
        ...
        public override object Clone()
        {
            ...
            // Глубокое копирование полей класса BigCar
            clonedCar.OffRoadType = string.Copy(this.OffRoadType); // Клонируем строку
            clonedCar.AllWheelDrive = this.AllWheelDrive; // Простое значение (bool)
        ...
        {
            return HashCode.Combine(base.GetHashCode(), AllWheelDrive, OffRoadType);
        }
    }
}